...
end foodfight_antminer;
------------------------------------------------------------------------------
architecture struct of foodfight_antminer is
 ...
 --
 signal AX0            : std_logic_vector(7 downto 0);
 signal AY0            : std_logic_vector(7 downto 0);
 signal AX1            : std_logic_vector(7 downto 0);
 signal AY1            : std_logic_vector(7 downto 0);
...
--p1_controls <= "00" & joy_BBBBFRLDU(8) & joy_BBBBFRLDU(4) & joy_BBBBFRLDU(3) & joy_BBBBFRLDU(2) & joy_BBBBFRLDU(1) & joy_BBBBFRLDU(0);
--p2_controls <= "00" & joy_BBBBFRLDU(8) & joy_BBBBFRLDU(4) & joy_BBBBFRLDU(3) & joy_BBBBFRLDU(2) & joy_BBBBFRLDU(1) & joy_BBBBFRLDU(0);
--sys_controls <= "000" & joy_BBBBFRLDU(6) & joy_BBBBFRLDU(5) & "00" & joy_BBBBFRLDU(7);
...
-- DIN <= ~{bSelfTst,(m_trig22|m_trig21),(m_trig12|m_trig11),1'b0,m_start2,m_start1,1'b0,(m_coin1|m_coin2)};
DIN <= '1' & not joy_BBBBFRLDU(4)& not joy_BBBBFRLDU(8) & '1' & not joy_BBBBFRLDU(6) & not joy_BBBBFRLDU(5) & '1' & not joy_BBBBFRLDU(7);
---------------------------------------------------------------------------
A0 : entity work.PseudoAnaStk
port map(
CLK => pclk,
PV  => vpos,
LF  => joy_BBBBFRLDU(2),
