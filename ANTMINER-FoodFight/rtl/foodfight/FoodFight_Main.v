...
// ROMs
wire [15:0] r0dt,r1dt,r2dt,r3dt;                                            // rom data 7:0  & rom data 15:8 
// PRGxROM r0(cl,ad[12:0],r0dt, DLCL,DLAD,DLDT,DLEN & (DLAD[16:14]==3'b0_00)); // 136020-301.8c & 136020-302.9c
// PRGxROM r1(cl,ad[12:0],r1dt, DLCL,DLAD,DLDT,DLEN & (DLAD[16:14]==3'b0_01)); // 136020-303.8d & 136020-204.9d
// PRGxROM r2(cl,ad[12:0],r2dt, DLCL,DLAD,DLDT,DLEN & (DLAD[16:14]==3'b0_10)); // 136020-305.8e & 136020-306.9e
// PRGxROM r3(cl,ad[12:0],r3dt, DLCL,DLAD,DLDT,DLEN & (DLAD[16:14]==3'b0_11)); // 136020-307.8f & 136020-208.9f
//---------------------------------
cpu_prg_0o ROM0o ( // 136020-301.8c
.clk(cl), 
.addr(ad[12:0]), 
.data(r0dt[7:0])
);

cpu_prg_0e ROM0e ( // 136020-302.9c
.clk(cl), 
.addr(ad[12:0]), 
.data(r0dt[15:8])
);
//---------------------------------
cpu_prg_1o ROM1o ( // 136020-303.8d
.clk(cl), 
.addr(ad[12:0]), 
.data(r1dt[7:0])
);

cpu_prg_1e ROM1e ( // 136020-204.9d
.clk(cl), 
.addr(ad[12:0]), 
.data(r1dt[15:8])
);
//---------------------------------
cpu_prg_2o ROM2o ( // 136020-305.8e
.clk(cl), 
.addr(ad[12:0]), 
.data(r2dt[7:0])
);

cpu_prg_2e ROM2e ( // 136020-306.9e
.clk(cl), 
.addr(ad[12:0]), 
.data(r2dt[15:8])
);
//---------------------------------
cpu_prg_3o ROM3o ( // 136020-307.8f
.clk(cl), 
.addr(ad[12:0]), 
.data(r3dt[7:0])
);

cpu_prg_3e ROM3e ( // 136020-208.9f
.clk(cl), 
.addr(ad[12:0]), 
.data(r3dt[15:8])
);
